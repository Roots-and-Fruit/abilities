...
define( 'RF_ABILITIES_VERSION', '1.6.2' );
...
require_once RF_ABILITIES_PATH . 'includes/class-breeze.php';
...
require_once RF_ABILITIES_PATH . 'includes/class-key-takeaways.php';
